    ...
    <main class="app-main">
      ...
      <div class="app-content-header">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0">Menú prestamos</h3>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Menu Prestamos</li>
              </ol>
            </div>
          </div>
          <!--end::Row-->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <a href="{{ route('prestamos.create') }}" class="nav-link active">
                <div class="small-box text-bg-primary">
                  ...
                  <p class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
            ...
            <div class="col-lg-3 col-6">
              ...
              <a href="{{ route('prestamos.index') }}" class="nav-link active"> <!-- Añadido enlace aquí -->
                <div class="small-box text-bg-success">
                <div class="inner text-center">
                    
                <h1>Ver<br>Prestamos</h1>
                  </div>
                  <svg
                    class="small-box-icon"
                    fill="currentColor"
