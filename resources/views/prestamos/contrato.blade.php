...
<head>
    ...
    <style>
        ...
        .shadow-lg { box-shadow: 0 0 10px rgba(0,0,0,0.15); }
...
<div class="container bg-white p-4 rounded shadow-lg">
    ...
    <p><strong>1. MONTO DEL PRÉSTAMO</strong><br>
        El PRESTADOR otorga al CLIENTE la cantidad de <strong>${{ number_format($prestamo->monto, 2) }} pesos mexicanos</strong>.</p>

    <p><strong>2. INTERÉS SEMANAL</strong><br>
        El préstamo generará un interés semanal del <strong>{{ $prestamo->interes }}%</strong>, que se pagará semana tras semana.</p>
